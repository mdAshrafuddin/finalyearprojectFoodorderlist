...
@section('content')
   ...
   @include('layouts.admin.meassage')
        ...
        <div class="panel">
          ...
          <a href="{{route('admin.resturant.create')}}" class="btn btn-primary float-right">Add Resturant</a>
            <table class="table table-hover dataTable table-striped w-full" id="exampleTableTools">
             ...
             @foreach ($resturants as $key => $resturant)
               <tr role="row" class="odd">
                  ...
                  <td>{{\Carbon\Carbon::parse($resturant->created_at)->diffForHumans()}}</td>
                <td>{{\Carbon\Carbon::parse($resturant->updated_at)->diffForHumans()}}</td>
                  <td>
                  <a href="{{route('admin.resturant.edit',$resturant->resturant_id)}}" class="btn btn-success btn-sm" >Edit</a>
                 <button type="button" class="btn btn-danger btn-sm" onclick="deleteCategory({{ $resturant->resturant_id }})">

                                            <i class="material-icons">delete</i>

                                        </button>

                                        <form id="delete-form-{{$resturant->resturant_id}}" action="{{route('admin.resturant.destroy',$resturant->resturant_id)}}" method="POST" style="display:none">
                                            @csrf
                                            @method('DELETE')
                                        </form>
...
<script type="text/javascript">
        ...
        function deleteCategory(resturant_id) {
            ...
            swalWithBootstrapButtons({
                ...
                document.getElementById('delete-form-'+resturant_id).submit();
            } else if (
