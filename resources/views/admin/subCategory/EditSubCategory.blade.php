            ...
            <div class="row row-lg">
              <div class="col-md-12">
                ...
                <div class="example-wrap">
                  ...
                  <div class="example">
                    <form autocomplete="off" action="{{route('admin.subcategory.update',$subcategories->catagoryID)}}" method="post">
                     @csrf
                     @method('PUT')
                      <div class="row">
                        <div class="form-group col-md-12 {{ $errors->first('subCatagoryName') or 'has-error' }}">
                          ...
                          value="{{ $subcategories->subCatagoryName }}"
                    ...
                    <select name="catagory" class="form-control">
                      {{-- <option>Add Your SubCategory</option> --}}
                        ...
                        @foreach ($categories as $category )
                           <option value="{{$category->catagoryID }}" {{$category->catagoryID == $subcategories->subCatagoryID ? 'selected' : ''}}>{{  }}$category->catagoryName}}</option> 
                        @endforeach    
